...
- Set routes for users and posts.
- `/` or `users` will display the list of available users.
- `users/:id` will display the details from a user by its id.
- `users/:id/posts` will display the list of posts from a given user.
- `users/:id/posts/:id` will display the details from a post by its id.
